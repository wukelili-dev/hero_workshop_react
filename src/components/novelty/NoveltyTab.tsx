...
export const NoveltyTab: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
      ...
      <p className="text-xs text-gray-400">收藏各种稀奇古怪的玩意儿，纯装饰，无实际用途。</p>

      {NOVELTY_ITEMS.map((item) => {
        const owned = hero.noveltyItems.includes(item.name);
        ...
        return (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              {owned && <span className="text-xs px-1.5 py-0.5 bg-green-100 text-green-600 rounded">已拥有</span>}
            </div>
