...
export const NPCS: NpcDefinition[] = [
...

  {
    ...
    tradeItems: [
      { label: '西域葡萄酒 [杂货]', type: 'novelty', price: 80, dialogue: '产自高昌国，路上要走半年，一坛能换一匹马。', name: '西域葡萄酒', icon: '🍷', description: '高昌国进贡的葡萄酒，色泽如红宝石，入口甘醇' },
      { label: '三勒浆 [杂货]', type: 'novelty', price: 50, dialogue: '三种果子酿的烈酒，喝下去连挨三刀都不觉得疼。', name: '三勒浆', icon: '🍶', description: '西域三种果实酿造的烈酒，长安贵族争相求购' },
      { label: '烤全羊 [恢复30HP]', type: 'potion', price: 45, potionCount: 1, dialogue: '后厨现烤的，撒了孜然和胡荽，香飘三条街！' },
      { label: '小经验丹 [+100 EXP]', type: 'novelty', price: 100, dialogue: '西域传来的秘药，服下后浑身发热，功力大涨。', name: '小经验丹', icon: '💊', description: '西域秘制的丹药，可增进功力' },
      { label: '中经验丹 [+500 EXP]', type: 'novelty', price: 450, dialogue: '高昌国宫廷秘藏，据说只有贵族才能享用。', name: '中经验丹', icon: '💊', description: '高昌国宫廷秘藏丹药，功力大增' },
      { label: '大经验丹 [+2000 EXP]', type: 'novelty', price: 1600, dialogue: '传说中的仙丹，奴家也是费了好大功夫才弄到的～', name: '大经验丹', icon: '🧪', description: '传说中的仙丹，凡人服用可抵十年苦修' },
    ],
